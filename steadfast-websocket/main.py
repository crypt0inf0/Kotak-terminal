...
from kotakneo.kotakneo_websocket import (
    main as kotakneo_main
)
...
BROKER_PORTS = {"flattrade": 8765, "shoonya": 8766, "kotakneo": 8767}

IPC_PORT = 5555  # Using port 5555 to avoid conflicts
...
async def main():
    try:
        ...
        elif selected_broker == "kotakneo":
            await kotakneo_main(ws_port)
